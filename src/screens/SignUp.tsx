import {Center, Heading, KeyboardAvoidingView, ScrollView, Text, VStack } from "native-base";
    ...
    <KeyboardAvoidingView behavior='padding' bg='gray.6'>
      <ScrollView contentContainerStyle={{flexGrow: 1}}>
        <VStack flex={1} pt={16} px={12} alignItems='center'>
          ...
          <Heading fontFamily='heading' fontSize='xl' color='gray.1' pt={3} pb={2} >Welcome!</Heading>

          <Text textAlign='center' fontFamily='body' fontSize='sm' color='gray.2' mb={4}>
